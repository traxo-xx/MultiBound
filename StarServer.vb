...
Public Class StarServer
    ...
    Public Overrides Sub DoListen()
        ...
        Do
            ...
            Clients.Last.SendMessage(ProtocolVersion)
            Console.WriteLine("Sending Server Protocol: " & BitConverter.ToString(ProtocolVersion))
        Loop
    End Sub
        ...
        Try
            ...
            Select Case Data(0)
                ...
                Case OPCodes.ClientContextUpdate
                    If connectionvalid = False Then
                        connectionvalid = True
                        Console.WriteLine("Player has entered playing state. Unfortunaltely all they can see is a black screen.")
                        Console.WriteLine("No further code has been written. That's all folks!")
                    End If
                Case 0
                    'Blank Data
                Case Else
                    Console.WriteLine("Invalid opcode 0x" & Data(0).ToString("X2")) '& "; data sent: " & BitConverter.ToString(arr))
            End Select
        Catch
        End Try
    End Sub
